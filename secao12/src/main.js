...
class App{
    ...
    async adicionarRepositorio(evento){
        ...
        try{
            ...
            // Limpando erro existente
            if(document.querySelector('.list-group-item-danger') !== null){
                this.lista.removeChild(document.querySelector('.list-group-item-danger'))
            }
            // SOLUCAO DA AULA
            ...
            let txtErro = document.createTextNode(`O repositório ${input} não exite.`);
